...
const DETAIL_STYLES = `
  ...
  .ic-byline__who { font-size: .9375rem; font-weight: 600; line-height: 1.3; }
  ...
  .ic-comment__meta { font-size: .8125rem; opacity: .6; margin: 0 0 .25rem; }
  .ic-comment__body { margin: 0; line-height: 1.65; white-space: pre-wrap; word-break: break-word; }
