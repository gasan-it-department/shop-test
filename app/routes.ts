...
export default [
  ...
  route("app", "routes/app.tsx", [
    ...
    route("comments", "routes/app.comments.tsx"),
    ...
    route("diagnostics", "routes/app.diagnostics.tsx"),
  ]),
  ...
  // must be listed separately: this config is explicit, so a file in
  // app/routes is not a route until it appears here
  route("proxy/posts/:id/like", "routes/proxy.posts.$id.like.tsx"),
